from __future__ import annotations  # Đảm bảo tương thích Type Hinting cho mọi phiên bản Python
import gzip
import hashlib
import os
import re
    ...
    for match in matches.values():
        ...
        if anchors:
            for anchor in anchors:
                ...
                lines.append(f'#EXTINF:-1 tvg-logo="{logo}" group-title="Gà Vàng TV",{display}')
...
# ══════════════════════════════════════════════════════════════════════════════
#  Background pre-fetch (parallel) - ĐÃ FIX THIẾU LOGIC GÀ VÀNG
# ══════════════════════════════════════════════════════════════════════════════
...
def index():
    ...
    return (
        ...
        f"<p>🟢 Gà Vàng TV: <strong>{gavang_count} kênh</strong>"
        ...
        f"<p>📡 Kênh Batman: <strong>{batman_count} kênh</strong></p>"
        f"{err_html}"
